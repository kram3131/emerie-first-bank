        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {savingsAccounts.map((account) => (
              <div
                key={account.name}
                className="bg-cream rounded-2xl border border-border p-8"
              >
                ...
                <div className="mt-4 pt-4 border-t border-border text-xs text-body-light">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-navy rounded-2xl p-10 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Digital Banking</h2>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div className="bg-white/10 rounded-xl p-5">
                  ...
                  <div className="text-xs text-white/60 mt-1">Daily mobile deposit limit</div>
                </div>
                <div className="bg-white/10 rounded-xl p-5">
                  <div className="text-2xl font-bold text-gold">$1,000</div>
                  <div className="text-xs text-white/60 mt-1">Zelle per transaction</div>
                </div>
                <div className="bg-white/10 rounded-xl p-5">
                  <div className="text-2xl font-bold text-gold">$5,000</div>
                  <div className="text-xs text-white/60 mt-1">External transfer limit</div>
                </div>
                <div className="bg-white/10 rounded-xl p-5">
                  <div className="text-2xl font-bold text-gold">55K+</div>
                  <div className="text-xs text-white/60 mt-1">Free ATMs via Allpoint</div>
                </div>
              </div>
            </div>
          </div>
