              ...
              {businessChecking.map((account) => (
                <div
                  ...
                  className={`relative bg-white rounded-2xl p-6 flex flex-col transition-shadow ${
                    account.badge ? "shadow-lg scale-[1.02] ring-1 ring-teal/20" : "shadow-sm hover:shadow-md"
                  }`}
                >
                  {account.badge && (
          ...
          <AnimateOnScroll animation="stagger-children">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {businessSavings.map((account) => (
                <div key={account.name} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow p-8">
                  ...
                  <div className="pt-4 border-t border-border/60 text-xs text-body-light">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <AnimateOnScroll animation="reveal">
            <div className="mb-10 text-center">
              <span className="relative inline-flex items-center gap-2 px-5 py-2.5 bg-teal/10 text-teal text-sm font-semibold rounded-full">
                <div className="absolute inset-0 rounded-full ring-1 ring-teal/20" />
                <svg className="w-5 h-5 relative" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                <span className="relative">SBA Preferred Lender</span>
              </span>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="reveal">
            <div className="bg-navy grain-overlay rounded-2xl p-10 md:p-12 relative overflow-hidden">
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-2xl font-light text-white mb-4 tracking-tight">Treasury Management</h2>
